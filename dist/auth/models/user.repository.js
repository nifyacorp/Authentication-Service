...
export const userRepository = {
     ...
     * Create a new user
     */
    async createUser(email, passwordHash, name, googleId, pictureUrl) {
        ...
        const result = await query(`INSERT INTO users (email, password_hash, first_name, last_name, google_id, picture_url, email_verified)
       VALUES ($1, $2, $3, $4, $5, $6, $7)
       RETURNING *`, [email, passwordHash, first_name, last_name, googleId, pictureUrl, googleId ? true : false]);
