...
export const authService = {
     ...
     */
    async syncUserToBackend(userId, email) {
        try {
            ...
            if (!apiKey) {
                try {
                    ...
                    console.error('Failed to get SYNC_USERS_API_KEY from Secret Manager:', secretError instanceof Error ? secretError.message : 'Unknown error');
                }
            }
            if (!apiKey) {
